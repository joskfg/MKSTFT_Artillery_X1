...
#define _LANGUAGE_RU_H_
    ...
    #define RU_FEATURE_SETTINGS     "Другие"
    ...
    #define RU_CUSTOM               "Свои"
    #define RU_LEVELING             "Калибровки"
    ...
    #define RU_MESH                 "MBL"
    #define RU_NEXT                 "Next"
    #define RU_START                "Start"
    #define RU_ABL                  "Калиб.стол"
    #define RU_BLTOUCH              "Bltouch"
    #define RU_BLTOUCH_TEST         "Тест"
    #define RU_BLTOUCH_DEPLOY       "Опустить"
    #define RU_BLTOUCH_STOW         "Поднять"
    #define RU_BLTOUCH_REPEAT       "Точность Z"
    #define RU_PROBE_OFFSET         "Отступ"
    ...
    #define RU_FILAMENT_RUNOUT      "закончился филамент"
